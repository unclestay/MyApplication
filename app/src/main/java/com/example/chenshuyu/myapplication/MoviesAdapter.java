...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MovieViewHolder> {
    ...
    private List<GenreResult> allGenres;
    private List<MovieResult> movies;
    private OnMovieClickCallBack callback;

    private String IMAGE_BASE_URL = "http://image.tmdb.org/t/p/w500";

    public MoviesAdapter(List<MovieResult> movies, List<GenreResult> allGenres, OnMovieClickCallBack callback) {
    ...
    public void appendMovies(List<MovieResult> moviesToAppend) {
